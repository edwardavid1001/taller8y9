...
import co.edu.sena.project_2687365.model.repository.CategoryRepositoryImpl;
...
public class CategoryRegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        co.edu.sena.project_2687365.model.repository.Repository<Category> repository = new CategoryRepositoryImpl();
        int rows = 0;
        try {
        ...
        if (rows == 0){
            //infoMessage = "Lo sentimos, ocurrió un error!"
            System.out.println("Lo sentimos, ocurrió un error!");
        } else {
